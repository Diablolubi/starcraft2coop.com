...
<?= startHead() ?>
  ...
  <?= startContent() ?>
    ...
    <h3>尽量减少资源余量</h3>
    <p>现在可以开始优化资源余量。请记住，矿石清理完毕时需要“攒下”400 晶体矿，才能放下星灵枢纽；超出这一数额的才是真正的资源余量。流程结束时还剩余 100 晶体矿，但将其投入科技并不可行，因为科技无法帮助我们更快清理分矿。因此应当投资经济：只要不影响探机生产，就建造吸收站。</p>
    <p>我们可以找到这一操作的准确时间点：在表格中寻找从此以后资源余量始终高于建造吸收站所需 75 晶体矿的位置，也就是 0:41。从该行开始，将之后每一行的晶体矿减去 75，再重复这一过程进行优化。请记住，重新分配工人后，需要重新执行流程并重新收集资源余量数据。完整示例如下：</p>
    <div class="tableContainer">
        <table class="centered">
            ...
            <tr>
                ...
                <td></td>
                <td colspan="3">为了尽量减少拿下分矿前的资源余量，我们尽早放下吸收站。暂时不派探机采气，因为仍需要晶体矿建造星灵枢纽。</td>
                <td></td>
                <td colspan="3">星灵枢纽落地后，还会多出 100 晶体矿。可以等待建造传送门，也可以再放下一个吸收站来强化经济。这里选择建造吸收站。</td>
        </table>
    </div>
    <h2 id="closing">结语</h2>
