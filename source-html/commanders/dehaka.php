...
<?= startHead() ?>
  ...
  <style>
        #content{
            background: url(/images/commanderdata/bgs/dehaka.png);
  ...
  <?= startContent() ?>
    ...
    <li>扎加拉：只有顶级掠食者的深槽虫道会缩短冷却时间。</li>
    <li>泽拉图：顺势斩和虚空探索者会缩短冷却时间；化身和所有军团也会缩短冷却时间。</li>
    <br>
    <table class="prestigeTable">
        <tbody>
            <tr>
                <td class="prestigeTitle" colspan="2">P2：<strong>原始竞争者</strong></td>
            </tr>
            <tr>
                <th>优点</th>
                <td>
    ...
    <table class="prestigeTable">
        <tbody>
            <tr>
                <td class="prestigeTitle" colspan="2">P3：<strong>原生双雄</strong></td>
            </tr>
            <tr>
                <th>优点</th>
                <td>
    ...
    <p>威望选择取决于玩家和盟友的操作水平。高水平盟友往往能充分利用“吞噬者”；熟悉族群首领用法的玩家则能从“原始竞争者”中获得很高收益。若希望打法更稳妥，也可以不选择威望。</p>
    <h2 id="hero">英雄单位</h2>
