...
<?= startHead() ?>
  ...
  <style>
        #content{
            background: url(/images/commanderdata/bgs/zagara.png);
  ...
  <?= startContent() ?>
    ...
    <table class="prestigeTable">
        <tbody>
            <tr>
                <td class="prestigeTitle" colspan="2">P1：<strong>爆蚊虫后</strong></td>
            </tr>
            <tr>
                <th>优势</th>
                <td>
    ...
    <table class="prestigeTable">
        <tbody>
            <tr>
                <td class="prestigeTitle" colspan="2">P2：<strong>构造体之母</strong></td>
            </tr>
            <tr>
                <th>优势</th>
                <td>
    ...
    <table class="prestigeTable">
        <tbody>
            <tr>
                <td class="prestigeTitle" colspan="2">P3：<strong>顶级掠食者</strong></td>
            </tr>
            <tr>
                <th>优势</th>
                <td>
    ...
    <p>精通前练级时，英雄单位因缺少等级 15 解锁而较为弱势，因此推荐使用“构造体之母”威望。偏好 F2 一键框选、平 A 推进的玩家不选择任何威望即可获得应对各种情况所需的完整工具；而操作英雄更加积极、更具进攻性的玩家，通常能从“顶级掠食者”威望中获得很高收益。</p>
    <h2 id="hero">英雄单位</h2>
