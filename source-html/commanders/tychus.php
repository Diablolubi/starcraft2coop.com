...
<?= startHead() ?>
  ...
  <?= startContent() ?>
    ...
    <table class="prestigeTable">
        <tbody>
            <tr>
                <td class="prestigeTitle" colspan="2">P1：<strong>技术招募员</strong></td>
            </tr>
            <tr>
                <th>优势</th>
                <td>
    ...
    <table class="prestigeTable">
        <tbody>
            <tr>
                <td class="prestigeTitle" colspan="2">P3：<strong>尽职的遛狗人</strong></td>
            </tr>
            <tr>
                <th>优势</th>
                <td>
    ...
    <p>常规玩法中，泰凯斯的三个威望都是可靠选择。技术招募员泛用性强，能轻松应对任何地图，是不错的选择。</p>
