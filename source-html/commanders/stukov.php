...
<?= startHead() ?>
  ...
  <?= startContent() ?>
    ...
    <table class="prestigeTable">
        <tbody>
            <tr>
                <td class="prestigeTitle" colspan="2">P1：<strong>恐怖血肉焊工</strong></td>
            </tr>
            <tr>
                <th>优势</th>
                <td>
    ...
    <table class="prestigeTable">
        <tbody>
            <tr>
                <td class="prestigeTitle" colspan="2">P2：<strong>瘟疫典狱长</strong></td>
            </tr>
            <tr>
                <th>优势</th>
                <td>
    ...
    <table class="prestigeTable">
        <tbody>
            <tr>
                <td class="prestigeTitle" colspan="2">P3：<strong>感染大军之主</strong></td>
            </tr>
            <tr>
                <th>优势</th>
                <td>
    ...
    <p>恐怖血肉焊工让斯托科夫在最弱势的前期就能使用他最强大的单位。这一威望用途广泛，整体表现胜过其他威望，至少在常规玩法中最值得推荐。</p>
